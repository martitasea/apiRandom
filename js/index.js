...
fetch("https://randomuser.me/api?results=100")
    ...
    .then(personajes => {
        ...
        <div id="datos">
            <h1 id="name">
                ${personas.name.title} ${personas.name.first} ${personas.name.last}
                </h1>
            <p id="gender">
            ${(((personas.gender) == "male") ? '<img class="simGender" src="img/male-01.svg"></img>' : '<img class="simGender" src="img/female-01.svg"></img>')}
            ${personas.gender.toUpperCase()}
            </p>
            <p id="city">
                ${personas.location.city} ${personas.location.country.toUpperCase()}
            </p>
            <p id="street">
                ${personas.location.street.number} ${personas.location.street.name}
            </p>
            <div id="contacto">
                <p id="email">
                    ${personas.email}
